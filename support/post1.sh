...
sed -i 's/copyright:.*/copyright: "©2025 Entrar"/g' /usr/share/meteor/bundle/programs/server/assets/app/config/settings.yml
...
sed -i 's/displayBbbServerVersion: true/displayBbbServerVersion: false/g' /usr/share/meteor/bundle/programs/server/assets/app/config/settings.yml
